...
// --- Status -> tampilan banner (warna, ikon, label) ---
...
export default function ReportDetailModal({
  ...
  const banner = STATUS_BANNER[laporan.status] ?? STATUS_BANNER["Menunggu"];
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-5 space-y-5">
              {/* Status banner */}
              <div className={`flex items-center gap-2 rounded-xl border px-4 py-3 ${banner.bg} ${banner.border}`}>
                <StatusIcon status={laporan.status} className={`h-4 w-4 flex-shrink-0 ${banner.text}`} />
