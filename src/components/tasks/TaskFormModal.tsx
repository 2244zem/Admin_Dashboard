          ...
          >
            ...
            <div className="px-6 py-5 space-y-5 max-h-[70vh] overflow-y-auto">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Jenis Tugas</label>
                  <select
                    value={form.tugas_id}
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Nama Tugas (Optional)</label>
                <input
                  type="text"
                  value={form.namaTugas}
                  onChange={(e) => handleFormChange("namaTugas", e.target.value)}
                  placeholder="Opsional: nama spesifik untuk tugas ini"
                  className="w-full bg-white text-gray-700 text-sm rounded-xl px-4 py-2.5 outline-none border border-gray-300 hover:border-gray-400 focus:border-[#0F4C81] focus:ring-2 focus:ring-blue-100"
                />
              </div>
              ...
              <div>
                ...
                <select
                  value={form.ob_id}
                  onChange={(e) => handleFormChange("ob_id", e.target.value)}
                  className="w-full bg-white text-gray-700 text-sm rounded-xl px-4 py-2.5 outline-none border border-gray-300 hover:border-gray-400 focus:border-[#0F4C81] focus:ring-2 focus:ring-blue-100"
                >
