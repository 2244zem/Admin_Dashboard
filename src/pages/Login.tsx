      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 px-8 py-4 border-t border-gray-100 bg-gray-50/50">
          ...
          <div className="flex items-center gap-4 text-xs text-gray-500">
            <button type="button" className="hover:text-[#0F4C81] transition-colors cursor-pointer">Privasi</button>
            <button type="button" className="hover:text-[#0F4C81] transition-colors cursor-pointer">Syarat &amp; Ketentuan</button>
          </div>
        </div>
      </div>
    </div>
